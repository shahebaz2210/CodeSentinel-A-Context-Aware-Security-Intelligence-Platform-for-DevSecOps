...
function ScoreRing({ score }: { score: number | null }) {
  const s = score ?? 0;
  const color =
    s >= 80 ? "#4caf50" : s >= 50 ? "#f5c518" : "#ff3b3b";
  const r = 44;
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ color: "var(--cs-border)" }}>
            |
          </span>
            ...
            <button
              ...
              onClick={() => {
                if (scan?.repository_id) {
                  createScan(scan.repository_id).then(
                    (r) =>
                      router.push(
                        `/dashboard/scans/${r.scan_id}`
                      )
                  );
                }
              }}
        ...
        {isRunning && (
          ...
          >
            ...
            <div>
              ...
              >
                Running all 5 agents: Repository
          ...
          >
            ...
            <div>
              ...
              >
                ...
                deterministically from weighted
                risk factors
              </div>
